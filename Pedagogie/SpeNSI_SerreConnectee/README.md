...
<textarea display="inline">
    ...
    On obtient ainsi la température et l'humidité relative de l'air ambiant, données que l'on peut transmettre en HTML pour être visualisées via un navigateur.</textaera>
  <img alt="esp01 et DHT11" display="inline" float="right" src="https://github.com/SoproLab/Soprolab/blob/master/Pedagogie/SpeNSI_SerreConnectee/esp01_DHT11.jpg">
