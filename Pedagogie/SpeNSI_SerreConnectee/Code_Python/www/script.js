...
// Le code Python de la fonction page_Web ( ...) est chargé de réaliser la page HTML envoyée au navigateur.
// C'est dans cette fonction que l'on remplacera <variable_toit> par l'état de la trappe.
...
if (toit == "open" ) {
bp_open.className += 'hidden'; // Cacher OUVRIR   
}
